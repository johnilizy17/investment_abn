...
export default function Terms() {
    return (
        <NoAuthLayout title="Terms and Conditions">
            ...
            <Box color={COLORS.black} bg={COLORS.white}>

                <Box className="fade-slide bottom" p={["20px", "20px", "20px", "120px"]} pt="0px">
                    <Box h={["100px", "100px", "100px", "0px"]} />

                    <Box fontWeight={"800"} mb="20px" fontSize={"28px"}>
                        ABN LAND-DEY TERMS AND CONDITIONS
                    </Box>

                    <Box fontWeight={"500"} fontSize={"14px"} mb="20px">
                        {" This Agreement governs the participation of clients in ABN Land-Dey (Company). By subscribing or making payment, the Client (You) agrees to be bound by these Terms and Conditions."}
                    </Box>

                    {/* Subscription Packages */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>SUBSCRIPTION PACKAGES</Box>
                    </section>
                    ...
                    {/* Payment Terms */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>PAYMENT TERMS</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    {/* Land Allocation */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>LAND ALLOCATION</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>DEFAULT & CANCELLATION</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    {/* Documentation */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>DOCUMENTATION</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    {/* Referral Program */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>REFERRAL PROGRAM</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    {/* Liability */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>LIABILITY & DISPUTES</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    {/* Liability */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>Refund Terms and Condition</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>Expedit Option</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
                    ...
                    {/* Agreement */}
                    <section className="sm-container mt-lg fade-slide bottom">
                        <Box fontWeight={"700"} mb="10px" fontSize={"20px"}>AGREEMENT</Box>
                    </section>
                    <section style={{ marginBottom: 20 }} className="fade-slide bottom">
                        <blockquote>
